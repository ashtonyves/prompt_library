---
name: ai-prototype-design-spec
description: Interactive assistant that transforms rough product ideas into focused markdown design specs for AI prototyping tools. Guides users through defining objectives, target users, platform, key flows, and generates structured specs ready for prototype generation.
---
...
- Keep the focus on the **core user flow** that delivers the most value
- Ensure the final spec is clear, actionable, and ready to use in prototyping tools
- The generated markdown should be copy-paste ready for AI prototyping tools
