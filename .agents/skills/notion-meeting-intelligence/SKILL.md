...
description: Prepares meeting materials by gathering context from Notion, enriching with Codex research, and creating both an internal pre-read and external agenda saved to Notion. Helps you arrive prepared with comprehensive background and structured meeting docs.
---

# Meeting Intelligence

Prepares you for meetings by gathering context from Notion, enriching it with Codex research, and creating comprehensive meeting materials. Generates both an internal pre-read for attendees and an external-facing agenda for the meeting itself.
...
3. **Enrich with research**: Use Codex's knowledge to add context, industry insights, or best practices
...
### Step 4: Enrich with Codex research
...
- **Current Status**: 
  ...
  - Key metrics or data
- **Context & Insights** (from Codex research):
...
Beyond Notion content, add value through Codex's capabilities:
...
Note: Use general knowledge and analytical capabilities. Don't fabricate specific facts. Clearly distinguish Notion facts from Codex insights.
...
2. **Distinguish sources**: Label what's from Notion vs. Codex research
...
6. **Enrich thoughtfully**: Codex research should add real value, not fluff
...
**"Codex research too generic"**: Focus on specific insights relevant to the actual meeting topic, not general platitudes
