---
name: "source-command-summarize-work-skill"
...
# source-command-summarize-work-skill

Use this skill when the user asks to run the migrated source command `summarize-work-SKILL`.
