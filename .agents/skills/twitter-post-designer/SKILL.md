...
**Rough draft input:**
> I used Codex + Figma MCP to prototype a responsive data grid before I finalized my specs. Helped me figure out column pinning on small screens.

**Option 1 — Problem-first:**
> Had one design question I couldn't answer in Figma: how do you pin columns inside a nested scrollable grid on mobile?
> 
> Built a working prototype with Codex + Figma MCP. Answered it in 10 minutes of actual use.
> 
> Tools: Figma · Codex · Figma MCP

**Option 2 — Insight-first:**
> Static designs can't tell you if a nested scrollable grid actually works on mobile. Working prototypes can.
> 
> Used Codex + Figma MCP to get a real answer on column pinning before finalizing specs.
> 
> Tools: Figma · Codex · Figma MCP
...
> 
> Built a prototype with Codex + Figma MCP before finalizing specs. Column pinning became obvious fast.
> 
> Tools: Figma · Codex · Figma MCP